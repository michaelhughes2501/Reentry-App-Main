...
-- NOTE: Update these with proper Auth-based policies before production
CREATE POLICY "Allow all for development" ON participants FOR ALL USING (true) WITH CHECK (true);
